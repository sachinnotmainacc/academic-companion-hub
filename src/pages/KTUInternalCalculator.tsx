        ...
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">
              Calculate your KTU internal marks and check exam eligibility
            </p>
          </div>
                ...
                <div className="flex items-center space-x-3">
                  <Label 
                    ...
                    className={cn(
                      ...
                      !isLabMode ? "text-blue-400" : "text-gray-400"
                    )}
                  >
                    3-Credit Course
                  </Label>
                    ...
                    <>
                      ...
                      <div>
                        <div className="text-sm text-gray-400 mb-3">
                          {isLabMode ? "Achievable Grades" : "Required SEE Marks for Grades"}
                        </div>
                            ...
                            <thead>
                              <tr className="border-b border-dark-700">
                                ...
                                <th className="text-left py-2 px-3 text-gray-400">
                                  {isLabMode ? "Achievable Grade" : "Required SEE Marks"}
                                </th>
                              </tr>
                            </thead>
                            <tbody>
...
export default KTUInternalCalculator;
