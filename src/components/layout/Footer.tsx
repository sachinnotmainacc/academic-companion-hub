...
import { GraduationCap, BookOpen, Calculator, Clock, Map } from "lucide-react";
  ...
  return (
    <footer className="bg-dark-900 border-t border-dark-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mt-8 border-t border-dark-800 pt-8 flex flex-col md:flex-row justify-between">
          <p className="text-sm text-gray-400">
            &copy; {currentYear} College Daddy. All rights reserved.
          </p>
          <div className="mt-4 md:mt-0">
            <Link to="/terms" className="text-sm text-gray-400 hover:text-blue-400 transition-colors mr-4">
              Terms of Service
            </Link>
            <Link to="/privacy" className="text-sm text-gray-400 hover:text-blue-400 transition-colors">
              Privacy Policy
